...
/* Responsive: Pada layar lebih kecil, link ditampilkan secara vertikal */
...
<body>
    ...
    <a href="input.php" class="input-link">INPUT DATA</a>
    <a href="print.php" class="input-tink">CETAK LAPORAN</a>
</div>
